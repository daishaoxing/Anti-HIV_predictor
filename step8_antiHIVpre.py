...
SVMa_dict={}
RFa_dict={}
f1='H:/tcm_database/CMAUP.smi'### change
f2='./data/chembl_NCI_aids_active_final.smi'
f3=open('CMAUP_anti_HIV_prediction.txt','w')###change
...
###SVM
svm_model=joblib.load("./data/HIV_SVM_model_500_rbf_win.pkl.z")###change
...
###RF
RFmodel=joblib.load("./data/HIV_RF_model_1000_win.pkl.z")###change
